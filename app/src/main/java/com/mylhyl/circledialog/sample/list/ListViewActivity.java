    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.top_left).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new CircleDialog.Builder()
                        .setWidth(1f)
                        .setPopupAnchor(v)
                        .setPopupTriangleGravity(PopupParams.TRIANGLE_TOP_LEFT)
        ...
        findViewById(R.id.top_center).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new CircleDialog.Builder()
                        .setPopupAnchor(v)
                        .setPopupTriangleGravity(PopupParams.TRIANGLE_TOP_CENTER)
                        .setPopup(new String[]{"1", "2", "3", "4"}
                                , new OnRvItemClickListener() {
                                    @Override
                                    public void onItemClick(View view, int position) {
        ...
        findViewById(R.id.top_right).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new CircleDialog.Builder()
                        .setPopupAnchor(v)
                        .setPopupTriangleGravity(PopupParams.TRIANGLE_TOP_RIGHT)
                        .setPopup(new String[]{"1", "2", "3", "4"}
                                , new OnRvItemClickListener() {
                                    @Override
                                    public void onItemClick(View view, int position) {
        ...
        findViewById(R.id.bottom_left).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new CircleDialog.Builder()
                        .setPopupAnchor(v)
                        .setPopupTriangleGravity(PopupParams.TRIANGLE_BOTTOM_LEFT)
                        .setPopup(new String[]{"1", "2", "3", "4"}
                                , new OnRvItemClickListener() {
                                    @Override
                                    public void onItemClick(View view, int position) {
        ...
        findViewById(R.id.bottom_center).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new CircleDialog.Builder()
                        .setPopupAnchor(v)
                        .setPopupTriangleGravity(PopupParams.TRIANGLE_BOTTOM_CENTER)
                        .setPopup(new String[]{"1", "2", "3", "4"}
                                , new OnRvItemClickListener() {
                                    @Override
                                    public void onItemClick(View view, int position) {
        ...
        findViewById(R.id.bottom_right).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new CircleDialog.Builder()
                        .setPopupAnchor(v)
                        .setPopupTriangleGravity(PopupParams.TRIANGLE_BOTTOM_RIGHT)
                        .setPopup(new String[]{"1", "2", "3", "4"}
                                , new OnRvItemClickListener() {
                                    @Override
                                    public void onItemClick(View view, int position) {
        ...
        findViewById(R.id.left_top).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new CircleDialog.Builder()
                        .setPopupAnchor(v)
                        .setPopupTriangleGravity(PopupParams.TRIANGLE_LEFT_TOP)
                        .setPopup(new String[]{"1", "2", "3", "4"}
                                , new OnRvItemClickListener() {
                                    @Override
                                    public void onItemClick(View view, int position) {
        ...
        findViewById(R.id.left_center).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new CircleDialog.Builder()
                        .setPopupAnchor(v)
                        .setPopupTriangleGravity(PopupParams.TRIANGLE_LEFT_CENTER)
                        .setPopup(new String[]{"1", "2", "3", "4"}
                                , new OnRvItemClickListener() {
                                    @Override
                                    public void onItemClick(View view, int position) {
        ...
        findViewById(R.id.left_bottom).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new CircleDialog.Builder()
                        .setPopupAnchor(v)
                        .setPopupTriangleGravity(PopupParams.TRIANGLE_LEFT_BOTTOM)
                        .setPopup(new String[]{"1", "2", "3", "4"}
                                , new OnRvItemClickListener() {
                                    @Override
                                    public void onItemClick(View view, int position) {
        ...
        findViewById(R.id.right_top).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new CircleDialog.Builder()
                        .setPopupAnchor(v)
                        .setPopupTriangleGravity(PopupParams.TRIANGLE_RIGHT_TOP)
                        .setPopup(new String[]{"1", "2", "3", "4"}
                                , new OnRvItemClickListener() {
                                    @Override
                                    public void onItemClick(View view, int position) {
        ...
        findViewById(R.id.right_center).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new CircleDialog.Builder()
                        .setPopupAnchor(v)
                        .setPopupTriangleGravity(PopupParams.TRIANGLE_RIGHT_CENTER)
                        .setPopup(new String[]{"1", "2", "3", "4"}
                                , new OnRvItemClickListener() {
                                    @Override
                                    public void onItemClick(View view, int position) {
        ...
        findViewById(R.id.right_bottom).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new CircleDialog.Builder()
                        .setPopupAnchor(v)
                        .setPopupTriangleGravity(PopupParams.TRIANGLE_RIGHT_BOTTOM)
                        .setPopup(new String[]{"1", "2", "3", "4"}
                                , new OnRvItemClickListener() {
                                    @Override
                                    public void onItemClick(View view, int position) {
